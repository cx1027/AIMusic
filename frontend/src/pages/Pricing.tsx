export default function Pricing() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <p className="mt-2 text-sm text-gray-300">Choose the plan that fits your AI music creation needs.</p>
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        {[
          { name: "Free", price: "$0", desc: "Try AI song generation" },
          { name: "Pro", price: "$9", desc: "More AI song credits + faster generation" },
          { name: "Studio", price: "$29", desc: "Unlimited AI songs + commercial use" }
        ].map((t) => (
